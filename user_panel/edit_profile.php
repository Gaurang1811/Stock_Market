                  ...
                  <form class="form-sample" method = "POST">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name = 'dateofbirth' type = 'text' value =  '<?= $dateofbirth ?>' class="form-control"  />
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name = 'address1' type="text" value = '<?= $address1 ?>' class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name = 'address2' type="text" value = '<?= $address2 ?>' class="form-control" />
                          </div>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <input name = 'postcode' type="text" value = '<?= $postcode ?>' class="form-control" />
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <?php require 'displaycountrylist.php';  ?>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div class="input-group col-xs-12">
                        <input type="file" id = 'realinput' class="form-control file-upload-info" style = 'display:none'>
                    ...
                    <div class = "row">
                        <button formmethod = "POST" formaction = "save_changes.php" type="submit" class="btn btn-success mr-2">Save Changes</button>
                    </div>
                  </form>
                </div>
              </div>
