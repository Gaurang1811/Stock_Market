    ...
    <div class="container">
      <div class="row">
        <div class="col-xl-9 mx-auto">
          ...
          <h2 style = "line-height: 1.5;"class="mb-5">If stock market experts were so expert, they would be buying stock, not selling advice.</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="features-icons-item mx-auto mb-5 mb-lg-0 mb-lg-3">
            ...
            <p class="lead mb-0">Featuring the power of Machine Learning using Python framework!</p>
          </div>
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-lg-6 h-100 text-center text-lg-left my-auto">
          <ul class="list-inline mb-2">
            <li class="list-inline-item">
              <a href="/stocker/aboutus">About</a>
            </li>
            <li class="list-inline-item">&sdot;</li>
            <li class="list-inline-item">
              <a href="/stocker/feedback/">Contact</a>
            </li>
            <li class="list-inline-item">&sdot;</li>
            <li class="list-inline-item">
          ...
          <p class="text-muted small mb-4 mb-lg-0">Copyright &copy; <a href="/stocker/">Stocker</a> 2019. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
